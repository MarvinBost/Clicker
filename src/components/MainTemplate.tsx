...
const MainTemplate: React.FC<MainTemplateProps> = ({ score, level, units, money, upgrades, handleClick, buyUpgrade, buyApprentice, buyDragon }) => (
  <main className="dark min-h-screen bg-gradient-to-b from-gray-900 to-gray-700 text-white p-8">
    ...
    <StatsPanel score={score} level={level} units={units} money={money} upgrades={upgrades} />
  </main>
);
